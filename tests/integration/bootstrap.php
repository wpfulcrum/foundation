...
namespace Fulcrum\Foundation\Tests\Integration;

if (version_compare(phpversion(), '5.6.0', '<')) {
    die('Whoops, PHP 5.6 or higher is required.');
}

define('FULCRUM_FOUNDATION_INTEGRATION_TESTS_DIR', __DIR__ . DIRECTORY_SEPARATOR);
define('FULCRUM_FOUNDATION_ROOT_DIR', dirname(dirname(__DIR__)) . DIRECTORY_SEPARATOR);
...
{
    require FULCRUM_FOUNDATION_INTEGRATION_TESTS_DIR . 'plugin.php';
}
